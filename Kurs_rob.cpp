...
// Kurs_rob.cpp : Определяет поведение классов для приложения.
//

#include "stdafx.h"
#include "Kurs_rob.h"
#include "Kurs_robDlg.h"
...
BEGIN_MESSAGE_MAP(CKurs_robApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CKurs_robApp

CKurs_robApp::CKurs_robApp()
{
...
// Единственный объект CKurs_robApp

CKurs_robApp theApp;


// инициализация CKurs_robApp

BOOL CKurs_robApp::InitInstance()
{
